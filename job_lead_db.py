    ...
    if view_mode == "Table":
        ...
        for job in filtered:
            ...
            st.markdown(
                ...
                +'<div class="lead-reason"><strong>Reason:</strong> '+job.get("reason","")+"</div>"
                +"</div>"
    ...
    # ══════════════════════════════════════════════════════════════════════════════
        ...
        if st.session_state.get("db_loaded") and "db_jobs" in st.session_state:
            ...
            st.markdown(
                ...
                '<div>Hit "Search" to view all saved leads, or filter by keyword / priority</div></div>',
                unsafe_allow_html=True)
